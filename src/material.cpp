...
Material::Material():reflect_percent(0), refract_percent(0), diffuse_percent(1), refract_index(0), absorb_color(Color(0,0,0)), img(0,0),high_light(0),color(Color(1,1,1)){}
